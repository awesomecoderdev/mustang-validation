...
use Mustang\Core\Loader;
use Mustang\Backend\Backend;
use Mustang\Frontend\Frontend;
...
class Mustang
{
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Mustang   $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	private function define_admin_hooks()
	{
		...
		$plugin_backend = new Backend($this->get_plugin_name(), $this->get_version());
